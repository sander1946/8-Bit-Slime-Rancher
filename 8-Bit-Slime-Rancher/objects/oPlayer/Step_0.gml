...
keyActivate = keyboard_check_pressed(vk_space) || mouse_check_button_pressed(ev_left_press);
keyItem = keyboard_check_pressed(vk_control) || mouse_check_button_pressed(ev_right_press);
